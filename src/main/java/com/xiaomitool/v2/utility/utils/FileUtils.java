...
public class FileUtils {
  ...
  public static String readAll(File file) throws IOException {
    BufferedInputStream inputStream =
        new BufferedInputStream(new FileInputStream(file), FILE_READ_BUFFER_SIZE);
  ...
  public static void writeAll(File file, String output) throws IOException {
    BufferedOutputStream outputStream =
        new BufferedOutputStream(new FileOutputStream(file), FILE_READ_BUFFER_SIZE);
  ...
  public static Path searchFile(
      Path directory, String filename, boolean caseSensitive, int maxDepth) throws IOException {
    if (filename == null) {
      return null;
    }
