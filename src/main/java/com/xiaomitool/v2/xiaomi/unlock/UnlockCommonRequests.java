...
public class UnlockCommonRequests {
  ...
  public static String nonceV2() throws XiaomiProcedureException, CustomHttpException {
    ...
    request.addParam(
        "r",
        new String(
            StrUtils.randomWord(16).toLowerCase().getBytes(ResourcesConst.interalCharset()),
  ...
  public static String deviceClear(String product)
  ...
  public static String ahaFlash(String flashToken)
      throws XiaomiProcedureException, CustomHttpException {
    XiaomiKeystore keystore = XiaomiKeystore.getInstance();
  ...
  public static String ahaUnlock(
      String token, String product, String boardVersion, String deviceName, String socId)
      throws XiaomiProcedureException, CustomHttpException {
