...
public class DeviceRequestParams extends DefaultRequestParams implements Cloneable {
  ...
  public static DeviceRequestParams readFromDevice(Device device, boolean requireOtaParameters)
      throws AdbException {
    ...
    if (requireOtaParameters) {
      try {
        ...
        throw new AdbException(
            "Missing required ota parameter in device properties: " + e.getMessage());
      }
    }
    int z;
