...
public class XiaomiCrypto {
  public static final byte[] UNLOCK_HMAC_KEY =
      buildHmacKey(
  ...
  public static String cloudService_encrypt(String data, String key) throws Exception {
    ...
    return Base64.encodeBase64String(
        AES.aes128cbc_encrypt(
            bkey,
            DEFAULT_IV.getBytes(StandardCharsets.ISO_8859_1),
            data.getBytes(ResourcesConst.interalCharset())));
  }
  ...
  public static String cloudService_decrypt(String data, String key) throws Exception {
    ...
    return new String(
        AES.aes128cbc_decrypt(bkey, DEFAULT_IV.getBytes(StandardCharsets.ISO_8859_1), bdata),
        ResourcesConst.interalCharset());
  }

  public static void cloudService_encryptRequestParams(HttpQuery params, String key)
      throws Exception {
  ...
  public static String cloudService_signHmac(
      byte[] hmacKey, String method, String path, String query) {
    String hmacData = method + "\n" + path + "\n" + query;
    return new HmacUtils(HmacAlgorithms.HMAC_SHA_1, hmacKey)
        .hmacHex(hmacData.getBytes(ResourcesConst.interalCharset()));
  }
