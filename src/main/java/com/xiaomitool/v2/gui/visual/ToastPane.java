...
public class ToastPane {
  private static final Background TOAST_BACK =
      new Background(new BackgroundFill(Color.gray(0.8), new CornerRadii(20), null));
  private static final Border TOAST_BORDER =
      new Border(
          new BorderStroke(
              Color.gray(0.3), BorderStrokeStyle.SOLID, new CornerRadii(20), BorderStroke.THIN));
  ...
  private Transition[] getTransitions(Pane pane) {
    ...
    TranslateTransition translateTransition =
        new TranslateTransition(Duration.millis(TOAST_DURATION / 2), pane);
