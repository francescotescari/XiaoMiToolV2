...
public class ChooserPane extends StackPane {
  ...
  private static final Background CHOICE_BG_HOVER =
      GuiUtils.backgroundFromColor(Color.web("#ffb380"));
  ...
  private void build() {
    ...
    scrollPane.setStyle(
        "-fx-background: rgba(245,245,245,0); -fx-background-color: rgba(245,245,245,0);");
  ...
  private Node buildChoice(Choice choice) {
    ...
    double titWidth = title.getLayoutBounds().getWidth(),
        subWidth = subtext.getLayoutBounds().getWidth();
