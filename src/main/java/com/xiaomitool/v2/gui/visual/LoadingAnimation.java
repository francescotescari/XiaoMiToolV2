...
public class LoadingAnimation extends StackPane {
  ...
  private Transition buildTransition(Node circle) {
    ...
    transition.setInterpolator(
        new BezierInterpolator.WaitBezierInterpolator(
            0, easeParameter, 1 - easeParameter, 1, wait, wait));
    ...
    transition1.setInterpolator(
        new BezierInterpolator.WaitBezierInterpolator(0, easeParameter, 1, 1, 2 * wait, 0));
  ...
  public static class WithText extends VBox {
    ...
    private void build(String text) {
      ...
      LoadingAnimation animation =
          animWidth > 0 ? new LoadingAnimation(animWidth) : new LoadingAnimation();
