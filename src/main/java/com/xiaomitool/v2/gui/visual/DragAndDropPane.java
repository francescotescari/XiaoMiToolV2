...
public class DragAndDropPane extends StackPane {
  ...
  private Border getBorder(boolean dashed) {
    return new Border(
        new BorderStroke(
            Color.gray(0.4),
            dashed ? BorderStrokeStyle.DASHED : BorderStrokeStyle.SOLID,
            new CornerRadii(0.1, true),
            new BorderWidths((cWidth + cHeight) / 100)));
  }
