...
public class DeviceProperties {
  ...
  private final Properties adbProperties,
      fastbootProperties,
      sideloadProperties,
      recoveryProperties;
  ...
  class AdbProperties extends Properties {
    ...
    private void findUnlockStatusDevice() {
      this.put(
          X_LOCKSTATUS,
          DeviceGroups.hasUnlockedBootloader(getCodename(true))
              ? UnlockStatus.UNLOCKED
              : UnlockStatus.fromString((String) this.get("ro.secureboot.lockstate")));
    }
