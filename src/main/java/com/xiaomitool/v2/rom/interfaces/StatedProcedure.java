...
public interface StatedProcedure {
  LinkedHashSet<Device.Status> SET_FASTBOOT =
      ArrayUtils.createLinkedHashSet(Device.Status.FASTBOOT);
  LinkedHashSet<Device.Status> SET_RECOVERY =
      ArrayUtils.createLinkedHashSet(Device.Status.RECOVERY);
  LinkedHashSet<Device.Status> SET_SIDELOAD =
      ArrayUtils.createLinkedHashSet(Device.Status.SIDELOAD);
