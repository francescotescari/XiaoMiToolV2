...
public abstract class MiuiRom extends Installable {
  ...
  public String getText() {
    if (this.isFake()) {
      return this.isOfficial()
          ? LRes.ROM_LOCAL_OFFICIAL_SUB.toString()
          : LRes.ROM_LOCAL_SUB.toString();
    } else if (this.specie == null) {
  ...
  public Image getIcon() {
    return isFake()
        ? DrawableManager.getResourceImage(DrawableManager.LOCAL_PC)
        : DrawableManager.getResourceImage(this.specie.getDrawable());
  }
