...
public class AdvancedUpdateListener extends UpdateListener {
  ...
  public AdvancedUpdateListener(int updateEveryXMillis, OnAdvancedUpdate onAdvancedUpdate) {
    ...
    super.addOnUpdate(
        (downloaded, totalSize, latestDuration, totalDuration) -> {
                      ...
                      Duration.ofMillis(
                          (long)
                              ((totalSize - downloaded)
                                  / (0.92 * average.getDouble() + 0.08 * cacheSpeed.getDouble() + 1)
                                  * 1000)));
            }
  ...
  public static class TimeRemaining {
    ...
    public TimeRemaining(Duration duration) {
      ...
      TemporalUnit[] units =
          new TemporalUnit[] {ChronoUnit.SECONDS, ChronoUnit.MINUTES, ChronoUnit.HOURS};
      int i = 0;
