...
public class UpdateListener {
  ...
  public UpdateListener(
      OnStart onStart, OnUpdate onUpdate, OnFinished onFinished, OnError onError) {
    addOnStart(onStart);
  ...
  public void onUpdate(
      long downloaded, long totalSize, Duration latestDuration, Duration totalDuration) {
  ...
  public abstract static class OnFinished {
    public int priority = 5;
  ...
  public abstract static class OnError {
    public int priority = 5;
