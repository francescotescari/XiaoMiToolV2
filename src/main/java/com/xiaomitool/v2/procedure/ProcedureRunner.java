...
public class ProcedureRunner extends GuiListener {
  ...
  public Command handleException(InstallException exception, RInstall cause)
      throws InterruptedException, InstallException, RMessage {
  ...
  public Object requireContext(String key) throws InstallException {
    ...
    if (res == null) {
      throw new InstallException(
          "Failed to get context parameter: " + key, InstallException.Code.INTERNAL_ERROR);
    }
    return res;
  }
  ...
  public void startProcedure(RInstall procedure)
      throws InterruptedException, InstallException, RMessage {
