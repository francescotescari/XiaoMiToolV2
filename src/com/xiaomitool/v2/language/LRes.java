...
public enum  LRes  {
    ...
    UPDATE_AVAILABLE_TEXT("%s.\nIt is recommended to always update to the latest version of the tool because older version may contain more bugs or outdated procedures that could harm your device.\nLatest version available: %s\n\nDo you want to download the latest update?"),
