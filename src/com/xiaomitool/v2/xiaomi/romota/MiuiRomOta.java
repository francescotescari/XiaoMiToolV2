...
public class MiuiRomOta {
    ...
    HashMap<Kind, MiuiZipRom> otaV3_request(RequestParams params) throws XiaomiProcedureException, CustomHttpException {
        return otaV3_request(params, false);
    }

    public static @NotNull
    HashMap<Kind, MiuiZipRom> otaV3_request(RequestParams params, boolean throwOnCode) throws XiaomiProcedureException, CustomHttpException {
